...
class KnowBPDocumentsDetails extends StatefulWidget {
  const KnowBPDocumentsDetails({Key key, this.htmlElement,}) : super(key: key);
  final htmlElement;
  @override
  State<KnowBPDocumentsDetails> createState() => _KnowBPDocumentsDetailsState();
}

class _KnowBPDocumentsDetailsState extends State<KnowBPDocumentsDetails> {
