...
class FastTrackProjects extends StatefulWidget {
  const FastTrackProjects({Key key}) : super(key: key);

  @override
  State<FastTrackProjects> createState() => _FastTrackProjectsState();
}

class _FastTrackProjectsState extends State<FastTrackProjects> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text('Fast Track Projects',style: TextStyle(color: Colors.black)
        ),
      ...
      body:Stack(
        children: [
          WebView(
            ...
            initialUrl: Uri.encodeFull('https://autodcr.pmc.gov.in/bpams/PMC/ProposalAttachmentList.aspx?ListType=3'),
