...
class _OnGoingProjectsState extends State<OnGoingProjects> {
  ...
  Future<void> gettheme() async {
    ...
    isTheme = prefs.getString('_theme');
    print(isTheme);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text('On-Going Projects',style: TextStyle(color: Colors.black)
        ),
      ...
      body:Stack(
        children: [
          WebView(
            ...
            initialUrl: Uri.encodeFull('https://autodcr.pmc.gov.in/bpams/PMC/ProposalAttachmentList.aspx?ListType=2'),
