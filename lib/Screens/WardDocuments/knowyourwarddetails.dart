...
class KnowYourWardDetails extends StatefulWidget {
  const KnowYourWardDetails({Key key,  this.htmlElement }) : super(key: key);
  final htmlElement;
  @override
  State<KnowYourWardDetails> createState() => _KnowYourWardDetailsState();
}

class _KnowYourWardDetailsState extends State<KnowYourWardDetails> {
