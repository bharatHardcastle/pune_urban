...
class DpScreen2 extends StatefulWidget {
  final List<Map<String, Object>> dpdata;
  const DpScreen2({Key key, this.dpdata}) : super(key: key);

  @override
  State<DpScreen2> createState() => _DpScreen2State();
}

class _DpScreen2State extends State<DpScreen2> {
    ...
    return new Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, int currentIndex) {
          return ListTile(
              tileColor: currentIndex==0||currentIndex==14||currentIndex==22?Colors.grey[300]:Colors.transparent,
              title: currentIndex==0||currentIndex==14||currentIndex==22?Center(
                child: Text(
