...
class DpScreen3 extends StatefulWidget {
  final List<Map<String, Object>> dpdata;
  const DpScreen3({Key key, this.dpdata}) : super(key: key);

  @override
  State<DpScreen3> createState() => _DpScreen3State();
}

class _DpScreen3State extends State<DpScreen3> {
    ...
    return new Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, int currentIndex) {
          return ListTile(
              tileColor: currentIndex==0||currentIndex==11?Colors.grey[300]:Colors.transparent,
              title: currentIndex==0||currentIndex==11?Center(
                child: Text(
