...
class DpScreen4 extends StatefulWidget {
  final List<Map<String, Object>> dpdata;
  const DpScreen4({Key key, this.dpdata}) : super(key: key);

  @override
  State<DpScreen4> createState() => _DpScreen4State();
}

class _DpScreen4State extends State<DpScreen4> {
    ...
    return new Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, int currentIndex) {
          return ListTile(
              tileColor: currentIndex==0||currentIndex==11||currentIndex==22?Colors.grey[300]:Colors.transparent,
              title: currentIndex==0||currentIndex==11||currentIndex==22?Center(
                child: Text(
